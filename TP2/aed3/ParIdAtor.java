...
public class ParIdAtor implements RegistroArvoreBMais<ParIdAtor> {
    ...
    public ParIdAtor() throws Exception {
        this("", -1);
    }

    public ParIdAtor(String n) throws Exception {
        this(n, -1);
    }

    public ParIdAtor(String t, int i) throws Exception {
    ...
    @Override
    public ParIdAtor clone() {
        try {
            return new ParIdAtor(this.nome, this.id);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
    ...
    public int compareTo(ParIdAtor a) {
