...
public class indiceNomeSerie implements RegistroArvoreBMais<indiceNomeSerie> {
  ...
  public indiceNomeSerie() throws Exception {
    this("", -1);
  }

  public indiceNomeSerie(String n) throws Exception {
    this(n, -1);
  }

  public indiceNomeSerie(String t, int i) throws Exception {
  ...
  @Override
  public indiceNomeSerie clone() {
    try {
      return new indiceNomeSerie(this.nome, this.id);
    } catch (Exception e) {
      e.printStackTrace();
    }
    return null;
  ...
  public int compareTo(indiceNomeSerie a) {
